...
# In source mode this resolves to src/. In a PyInstaller build it resolves to
# the directory containing settings.exe, where the release package keeps www/
# and other writable runtime files.
SCRIPT_DIR = util.get_app_root()
...
CONST_SUPPORTED_SITES = ["https://kktix.com"
    ...
    ,"https://world.nol.com/ (NOL World / Interpark)"
    ,"===[香港或南半球的系統]==="
...
def get_default_config():
    ...
    config_dict["nolworld"] = {}
    config_dict["nolworld"]["check_interval"] = 5
    config_dict["nolworld"]["pre_sale_mode"] = False
    config_dict["nolworld"]["lock_only_mode"] = False
    ...
    config_dict["nolworld"]["session_timeout_minutes"] = 10
...
def migrate_config(config_dict):
    ...
    for section in ["advanced", "kktix", "tixcraft", "nolworld", "date_auto_select", "area_auto_select", "ocr_captcha", "contact", "accounts", "cityline"]:
